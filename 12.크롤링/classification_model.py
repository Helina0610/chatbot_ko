...
PREPROCESSED_PATH = "text_classification/output/round_robin_interleaved_v1.csv"
FINE_TUNED_MODEL_PATH = "fine_tuned_model_v1"
...
# ✅ 4단계: 추론 예제
pipe = pipeline("text-classification", model=MODEL_PATH, tokenizer=tokenizer, top_k=1)

sample_text = "해당 공무원의 행동은 인사자료 통보 수준으로 판단된다."
result = pipe(sample_text)
print("예측 결과:", result[0][0]["label"])
